...
export default function BottomChromeLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full z-30" style={{ background: "var(--background)" }}>
        {showCreateButton && (
          <div className="px-4 pt-3 pb-3 border-t-2" style={{ borderColor: "var(--border)" }}>
            <Button
              asChild
              size="xl"
              className="w-full shadow-[0_16px_30px_-12px_rgba(255,107,71,.55)]"
            >
