...
const MESSAGES_BY_CODE: Record<string, string> = {
  ...
  IMAGE_STORAGE_UNAVAILABLE: "No pudimos guardar las imágenes. Probá de nuevo más tarde.",
  ...
  INVALID_STATUS_TRANSITION: "La actividad cambió de estado. Actualizá la página.",
