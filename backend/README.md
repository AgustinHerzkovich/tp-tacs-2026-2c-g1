...
la JVM que lee — si sembrás desde tu máquina (con otra zona horaria) y el contenedor `app` corre en
...
que volver a correrlo pisa los mismos registros en vez de duplicarlos. Los usuarios sembrados
(`development-user`, `vale-rios`, `fede-molina`, `cami-paz`, `nico-gimenez`, `sol-alvarez`)
coinciden a propósito con el roster de login mockeado del frontend
