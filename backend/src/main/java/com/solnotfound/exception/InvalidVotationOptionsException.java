...
public class InvalidVotationOptionsException extends CodedException {
  ...
  public InvalidVotationOptionsException(List<LocalDateTime> invalidOptionDates) {
    this(ErrorCode.INVALID_VOTATION_OPTIONS, invalidOptionDates);
  }

  public InvalidVotationOptionsException(ErrorCode code, List<LocalDateTime> invalidOptionDates) {
    super(
        code,
