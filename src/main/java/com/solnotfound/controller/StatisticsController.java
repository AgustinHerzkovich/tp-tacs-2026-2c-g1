...
public class StatisticsController {
  ...
  public ResponseEntity<ActivityStatisticsResponse> getActivityStatistics(
    ...
    ActivityStatus status = activityStatus.orElseThrow(() -> new InvaildActivityStatusException("Invalid or missing activityType parameter"));
    ActivityStatisticsResponse activityStatisticsResponse = statisticsService.getActivityStatistics(status);
